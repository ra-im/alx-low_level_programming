# Here is a brief description of the purpose of every script in this directory.


## `0-print_list.c:`
prints all the elemnets of a `list_t` list.
- Prototype: `size_t print_list(const list_t *h);`
- Return: the number of nodes
- Format: see example
- if `str` is `NULL`, print `[0] (nil)`
- you are allowe to use `printf`
```
...
64-bit program in assembly that prints `Hello, Holberton`, follwed by a new line.
